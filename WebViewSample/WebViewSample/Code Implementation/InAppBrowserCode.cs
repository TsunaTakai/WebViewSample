...
namespace WebViewSample
{
	public class InAppBrowserCode : ContentPage
	{
		...
		public InAppBrowserCode (string URL)
		{
			...
			var backButton = new Button{ Text = "戻る", HorizontalOptions = LayoutOptions.Start };
			backButton.Clicked += backButtonClicked;

			var forwardButton = new Button{ Text = "進む", HorizontalOptions = LayoutOptions.EndAndExpand };
